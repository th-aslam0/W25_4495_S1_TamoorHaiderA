...
prompt = ChatPromptTemplate.from_messages([
    ("system", (
        ...
        "Your primary role is to help sentiment analysis in a meaningful and actionable way. "
        "You analyze Google Maps Scrapped data and provide insights on user mood. "
        "You support sentiment analysis of user feedback and predictive modeling based on historical trends.\n\n"
...
# Streaming Handler
class QueueCallbackHandlerReview(AsyncCallbackHandler):
...
class CustomAgentExecutor:
    ...
    async def invoke(self, input: str, streamer: QueueCallbackHandlerReview, verbose: bool = False) -> dict:
...
reviews_agent_executor = CustomAgentExecutor()  